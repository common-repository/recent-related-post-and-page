...
?>
<?php 
wp_register_style( 'rr_page_short4_style', false );
wp_enqueue_style( 'rr_page_short4_style' );
$css = " ";
ob_start(); ?>
...
<?php
$css .= ob_get_clean();
wp_add_inline_style( 'rr_page_short4_style', $css ); ?>

<?php 
wp_register_style( 'rr_page_short4_style1', false );
wp_enqueue_style( 'rr_page_short4_style1' );
$css = " ";
ob_start(); ?>
    <?php echo esc_attr($nwt_custom_css); ?>
<?php
$css .= ob_get_clean();
wp_add_inline_style( 'rr_page_short4_style1', $css ); ?>

<?php
wp_register_script( 'rr_page_short4_script', false );
wp_enqueue_script( 'rr_page_short4_script', 'src="http://ajax.googleapis.com/ajax/libs/webfont/1/webfont.js"' );
$js = " ";
ob_start(); ?>
...
<?php
$js .= ob_get_clean();
wp_add_inline_script( 'rr_page_short4_script', $js ); ?>

<div id="preloader_<?php echo esc_attr( $p_o_s_t ); ?>" align="center"><img
    src="<?php echo esc_url(WL_RP_PLUGIN_URL . 'settings/images/Preloader_1.gif'); ?>"/></div>
                      ...
                      <?php if ( ! $my_image == '' ) { ?>
                        <div align="center" id=" r_r_post_image_div_<?php echo esc_attr( $p_o_s_t ) ?>">
                            <div id="r_r_post_image_<?php echo esc_attr( $p_o_s_t ) ?>"
                               class="activity_rounded"><?php echo esc_url("<img src='$my_image'>"); ?></div>
                           </div>
                       <?php } ?>
