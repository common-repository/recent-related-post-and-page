...
defined('ABSPATH') || die();
 $a; ?>
<?php 
wp_register_style( 'rr_post_short_style', false );
wp_enqueue_style( 'rr_post_short_style' );
$css = " ";
ob_start(); ?>
    slider_div_<?php echo esc_attr($p_o_s_t.$a); ?>.vticker_<?php echo esc_attr($p_o_s_t).$a; ?> {
...
<?php
$css .= ob_get_clean();
wp_add_inline_style( 'rr_post_short_style', $css ); ?>

<?php
wp_register_script( 'rr_post_short_script', false );
wp_enqueue_script( 'rr_post_short_script' );
$js = " ";
ob_start(); ?>
...
<?php
$js .= ob_get_clean();
wp_add_inline_script( 'rr_post_short_script', $js ); ?>